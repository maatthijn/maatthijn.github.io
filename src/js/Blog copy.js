...
function Blog() {
    ...
    return (
        <>
            <div id="blog-content" className="page-root contents min-vh-100 min-vw-50 justify-content-center align-items-center d-flex flex-column" translate="yes">
            ...
            {
                selectedBlog &&
                <Offcanvas backdrop="static" placement="end" show={show} onHide={handleClose} className="blog-offcanvas-end" id="demo" translate="yes">
                    <Offcanvas.Header className="blog-offcanvas-header">
                        ...
                        <hr />
                        <span className="close" data-bs-dismiss="offcanvas" onClick={() => { setSelectedBlog(null); handleClose() }}>&times;</span>
                    </Offcanvas.Header>
